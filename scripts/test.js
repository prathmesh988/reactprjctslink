const restaurantList = [
    {
      type: "restaurant", //-->1st element of the list which is rastournatt 1
      data: {
        type: "F",
        id: "74453",
        name: "Domino's Pizza",
    ...
    {
      type: "restaurant", //-->2nd element of the list which is rastournatt 1
      data: {
        type: "F",
        id: "410476",
...
function censoring(data) {
    for (let index = 0; index < data.length; index++) {
        if (data[index] == 'stupid' || data[index] == 'idiot' || data[index] == 'dog') {
            data.splice(index, 1);
...
let hi = 'you are a stupid idiot dog';
